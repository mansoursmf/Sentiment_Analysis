...
#
# #for t in range(T):
#     # print("perceptron", p1.perceptron(toy_features, toy_labels, 90))
#     # print("avg_perceptron", p1.average_perceptron(toy_features, toy_labels, T))
#     # print("pegasos", p1.pegasos(toy_features, toy_labels, T, L))
#
#
#
#
